                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <div className="form-group">
                                ...
                                <input type="text" id="name" name="name" className="form-control" defaultValue="" placeholder="Abdul Majeed" required="" data-error="Please enter your Name" />
                        ...
                        <div className="col-md-6">
                            <div className="form-group">
                                ...
                                <input type="email" id="email" name="email" className="form-control" defaultValue="" placeholder="ask@abdulmajeed.com" required="" data-error="Please enter your Email" />
